...
int main(int argc,char* args[])
{
	...
	//	//vector<float> f = { 30.2946f, 51.6963f,
	//	//					65.5318f, 51.5014f,
	//	//					48.0252f, 71.7366f,
	//	//					33.5493f, 92.3655f,
	//	//					62.7299f, 92.2041f };
	//	//Mat t(f);
	//	//t.reshape(1,vector<int>{5, 2});
	//	//vector<float> g;
	//	//for (size_t i = 0; i < 5; i++)
	//	//{
	//	//	g[2 * i] = faces[0].landmarks[i].x;
	//	//	g[2 * i+1] = faces[0].landmarks[i].y;
	//	//	/*src_p[i] = faces[0].landmarks[i];
	//	//	target[i].x += 8.0;*/
	//	//}
	//	//Mat rt(g);
	//	//rt.reshape(1, vector<int>{5, 2});
	//	//memcpy(src_p, &[0], faces[0].landmarks.size() * sizeof(Point2f));
	//	Mat _dst(5, 2, CV_32F);
	...
	//	//Mat dst = Mat(src, faces[0].boundingbox);
	//	//
	//	imshow("align", warp);
	//	imshow("src", src);
	//	if (waitKey(1)==27)
